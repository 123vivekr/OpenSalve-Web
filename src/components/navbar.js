                ...
                {context => {
                    return (
                                ...
                                <Grid container spacing={0} className="navGrid">
                                    ...
                                    >
                                        <Button
                                            variant='contained'
                                            color='primary'
                                            disabled={this.props.location.pathname === '/requests'}
                                        >
                                            <Link
                                                to="/requests"
                        ...
                        <Button
                            variant='contained'
                            color='primary'
                            disabled={this.props.location.pathname === '/help'}
                        >
                            <Link
                                to="/help"
                    ...
                    <Grid item xs={6} sm={3}>
                        <Button
                            variant='contained'
                            color='primary'
                            disabled={this.props.location.pathname === '/analytics'}
                        >
                            <Link
                                to="/analytics"
                    ...
                    <Grid item xs={6} sm={3}>
                        <Button
                            variant='contained'
                            color='primary'
                            disabled={this.props.location.pathname === '/camps'}
                        >
                            <Link
                                to="/camps"
